    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          title:
              Text('Descargar PDF', style: TextStyle(fontSize: 18 * fontScale)),
          onTap: () {},
        ),
        const Divider(),
        ListTile(
          leading: const Icon(FontAwesomeIcons.whatsapp, color: Colors.green),
          title: Text('WhatsApp', style: TextStyle(fontSize: 18 * fontScale)),
          onTap: () {
        ...
        ListTile(
          ...
          title: Text('Facebook', style: TextStyle(fontSize: 18 * fontScale)),
          onTap: () {
        ...
        ListTile(
          ...
          title: Text('Instagram', style: TextStyle(fontSize: 18 * fontScale)),
          onTap: () {
        ...
        ListTile(
          ...
          title: Text('YouTube', style: TextStyle(fontSize: 18 * fontScale)),
          onTap: () {
